...
def collision_detection_manager(self : "LunaticAgent"):
        ...
        vehicle_detection_result = detect_obstacles_in_path(self, self.vehicles_nearby, self.config.distance.min_proximity_threshold)
        static_obstacle_detection_result = detect_obstacles_in_path(self, self.static_obstacles_nearby, self.config.distance.min_proximity_threshold)
