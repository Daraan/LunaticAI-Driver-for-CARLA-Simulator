...
class DynamicLocalPlanner(LocalPlanner):
    ...
    def _init_controller(self):
        ...
        self._vehicle_controller = VehiclePIDController(self._vehicle,
                                                        args_lateral=self.planner.config.lateral_control_dict,                               args_longitudinal=self.config.planner.longitudial_control_dict,
                                                        offset=self.config.controls.offset,
                                                        max_throttle=self.config.controls.max_throttle,
                                                        max_brake=self.config.controls.max_brake
                                            ,
                                                        max_steering=self.config.controls.max_steering)
    ...
    def run_step(self, debug=False):
        ...
        if self.config.distance.follow_speed_limits:
            self.config.live_info.target_speed = self._vehicle.get_speed_limit()
