...
class MapEntry():
    ...
    @property
    def openDriveDefaultIntersectionType(self) -> intersection.IntersectionType: ...

    @property
    def openDriveDefaultTrafficLightType(self) -> landmark.TrafficLightType: ...
...
class PointOfInterest():
    ...
    @property
    def geoPoint(self) -> point.GeoPoint: ...
