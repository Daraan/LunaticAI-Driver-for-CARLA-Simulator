...
class CoordinateTransform():
    ...
    def WGS84_R(self, lat: Latitude) -> Distance:
        '''
    ...
    def convert(self, arg1: CoordinateTransform, x: GeoPoint, y: ENUPointarg1: CoordinateTransform, x: ENUPoint, y: GeoPointarg1: CoordinateTransform, x: GeoPoint, y: ECEFPointarg1: CoordinateTransform, x: ECEFPoint, y: GeoPointarg1: CoordinateTransform, x: ECEFPoint, y: ENUPointarg1: CoordinateTransform, x: ENUPoint, y: ECEFPointarg1: CoordinateTransform, xs: GeoEdge, ys: ECEFEdgearg1: CoordinateTransform, xs: ENUEdge, ys: ECEFEdgearg1: CoordinateTransform, xs: ECEFEdge, ys: GeoEdgearg1: CoordinateTransform, xs: ENUEdge, ys: GeoEdgearg1: CoordinateTransform, xs: ECEFEdge, ys: ENUEdgearg1: CoordinateTransform, xs: GeoEdge, ys: ENUEdge) -> None:
        '''
