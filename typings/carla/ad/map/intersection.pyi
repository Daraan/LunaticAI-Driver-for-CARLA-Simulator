...
class CoreIntersection():
    ...
    def getCoreIntersectionFor(self, laneId: lane.LaneId, mapMatchedPosition: match.MapMatchedPosition) -> CoreIntersection:
        '''
    ...
    def getCoreIntersectionsFor(self, laneIds: lane.LaneIdSet, laneIds: lane.LaneIdList) -> vector_less_std_scope_shared_ptr_less_ad_scope_map_scope_intersection_scope_CoreIntersection_greater__greater_:
        '''
    ...
    def isLanePartOfAnIntersection(self, laneId: lane.LaneId) -> bool:
        '''
    ...
    def isLanePartOfCoreIntersection(self, arg1: CoreIntersection, laneId: lane.LaneId) -> bool:
        '''
...
class Intersection(CoreIntersection,):
    ...
    def extractLanesOfCoreIntersection(self, arg1: Intersection, laneId: lane.LaneId) -> None:
        '''
    ...
    def getEntryParaPointOfExternalLane(self, arg1: Intersection, laneId: lane.LaneId) -> point.ParaPoint:
        '''
    ...
    def getEntryParaPointOfInternalLane(self, arg1: Intersection, laneId: lane.LaneId) -> point.ParaPoint:
        '''
    ...
    def getExitParaPointOfExternalLane(self, arg1: Intersection, laneId: lane.LaneId) -> point.ParaPoint:
        '''
    ...
    def getExitParaPointOfInternalLane(self, arg1: Intersection, laneId: lane.LaneId) -> point.ParaPoint:
        '''
    ...
    def getIntersectionForRoadSegment(self, routeIterator: route.RouteIterator) -> Intersection:
        '''
    ...
    def getIntersectionsForRoute(self, route: route.FullRoute) -> vector_less_std_scope_shared_ptr_less_ad_scope_map_scope_intersection_scope_Intersection_greater__greater_:
        '''
    ...
    def getNextIntersectionOnRoute(self, route: route.FullRoute) -> Intersection:
        '''
