...
try:
    ...
    try:
        ...
        if "READTHEDOCS" not in os.environ:  # this module is mocked
            print("=====================================================")
            print(
                "WARNING: srunner is likely in PYTHONPATH, submodule `scenario_runner` is not used. "
...
if TYPE_CHECKING:
    ...
    from scenario_runner.srunner.scenariomanager.carla_data_provider import CarlaDataProvider  # noqa: TC004
    from scenario_runner.srunner.scenariomanager.timer import GameTime  # noqa: TC004
