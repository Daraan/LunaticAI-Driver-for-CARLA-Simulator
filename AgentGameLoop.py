...
def game_loop(args: LaunchConfig):
    ...
    try:
        ...
        ego_bp, _car_bp = launch_tools.blueprint_helpers.get_contrasting_blueprints()

        # Spawn Others
        GameFramework.request_new_batch_actors(
        ...
        agent, world_model, _global_planner, _controller = game_framework.init_agent_and_interface(
            ego=None if args.externalActor else ego,  # Test externalActor
